...
const s = StyleSheet.create({
  ...
  headerTitle: { fontSize: 18, fontWeight: "700", color: "#FFF", fontFamily: Platform.OS === "ios" ? "Georgia" : "serif" },
  ...
  avatarText: { fontSize: 19, fontWeight: "700", color: "#0D5C3A" },
  ...
  markerBadge: { backgroundColor: "#0D5C3A", paddingHorizontal: 8, paddingVertical: 3, borderRadius: 6 },
  ...
  addPlayerBtn: { flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8, paddingVertical: 16, borderRadius: 12, borderWidth: 2, borderColor: "#0D5C3A", borderStyle: "dashed", marginBottom: 12 },
  addPlayerText: { fontSize: 16, fontWeight: "700", color: "#0D5C3A" },

  bottomBar: { paddingHorizontal: 16, paddingVertical: 12, borderTopWidth: 1, borderTopColor: "#E8E4DA", backgroundColor: "#FFF" },
  confirmBtn: { flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8, backgroundColor: "#0D5C3A", paddingVertical: 14, borderRadius: 12 },
  ...
  teePickerRating: { fontSize: 13, fontWeight: "700", color: "#0D5C3A" },
});